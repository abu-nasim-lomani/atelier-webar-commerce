...
export default [
  {
    // next-env.d.ts is auto-generated by Next (and git-ignored). Next 15.5
    // adds a `/// <reference path=... />` line the strict ruleset rejects;
    // the file is regenerated every build, so it is excluded, not edited.
    ignores: [
      '.next/**',
      'node_modules/**',
      'next-env.d.ts',
      'src/tokens/tokens.generated.css',
    ],
  },
  {
    files: ['**/*.{ts,tsx}'],
